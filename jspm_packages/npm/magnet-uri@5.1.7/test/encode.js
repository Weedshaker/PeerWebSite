...
(function(Buffer) {
  ...
  test('encode: complicated magnet uri (multiple xt params, and as, xs)', function(t) {
    var uri = magnet.encode({
      xt: ['urn:ed2k:354B15E68FB8F36D7CD88FF94116CDC1', 'urn:tree:tiger:7N5OAMRNGMSSEUE3ORHOKWN4WWIQ5X4EBOOTLJY', 'urn:btih:QHQXPYWMACKDWKP47RRVIV7VOURXFE5Q'],
      xl: '10826029',
  ...
  test('encode: simple magnet uri using convenience names', function(t) {
    var obj = {
      ...
      tr: ['udp://tracker.example1.com:1337', 'udp://tracker.example2.com:80', 'udp://tracker.example3.com:6969', 'udp://tracker.example4.com:80', 'udp://tracker.example5.com:80'],
      announce: ['udp://tracker.example1.com:1337', 'udp://tracker.example2.com:80', 'udp://tracker.example3.com:6969', 'udp://tracker.example4.com:80', 'udp://tracker.example5.com:80'],
  ...
  test('encode: using infoHashBuffer', function(t) {
    var obj = {infoHashBuffer: Buffer.from('d2474e86c95b19b8bcfdb92bc12c9d44667cfa36', 'hex')};
    var result = magnet.encode(obj);
