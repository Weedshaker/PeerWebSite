  ...
  range_createClass(WrappedRange, [{
    ...
    value: function nativeRange() {
      if (env.isW3CRangeSupport) {
        ...
        // sst: adjusted
        w3cRange.setStart(this.sc || document.createElement('span'), this.sc && this.sc.data && this.so > this.sc.data.length ? 0 : this.so);
        w3cRange.setEnd(this.ec || document.createElement('span'), this.sc && this.sc.data ? Math.min(this.eo, this.sc.data.length) : this.eo);
        return w3cRange;
      } else {
