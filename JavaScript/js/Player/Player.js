...
export default class Player {
  constructor (id = 'player') {
    ...
    // value was 2000ms and made call stack excemption plus slowed down iphone
    this.waitToPlayMs = 4999 // ms, in random mode waiting for play before skipping to next (every pause/play action will trigger multiple of native events which will reset isLoading nextRandom and postpone the nextRandom to trigger)
