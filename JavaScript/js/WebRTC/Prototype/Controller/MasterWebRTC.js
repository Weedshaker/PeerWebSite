...
export class MasterWebRTC {
	constructor(){
		...
		this.connection.socketURL = window.sst && window.sst.isDebug ? `http://${window.location.hostname}:9001/` : 'https://webrtcweb.com:9002/'; // cd into repo: npm install --production / node server.js
