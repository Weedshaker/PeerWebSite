...
### Tutorials
[![Tutorial One](https://weedshaker.github.io/PeerWebSite/video/tutorialOneThumbnail.gif)](https://weedshaker.github.io/PeerWebSite/tutorialOne.mp4 "Tutorial One - Click to Watch!")
...
7. [IPFS HTML/CSS Example building a "website" using Browsers Developer Tools and saving to IPFS Desktop (3 Steps)](https://developer.mozilla.org/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools)
    ...
    2. [<img src="https://weedshaker.github.io/PeerWebSite/img/screenshot.5.jpg">](https://peerweb.site/#ipfs:Qmadp5HtLqh1vH6gpeLJLFvtcJMosKqV5HkoSvGSoM8b8A)
...
### peerweb.site [hosted@ipfs](https://ipfs.io/ipfs/QmVRQEdiqNwVxsMJtrhX8EQRHF3NJj4Aui5jXGUtDhA9Hd/index_no_tracking.html)
This is the CID: QmVRQEdiqNwVxsMJtrhX8EQRHF3NJj4Aui5jXGUtDhA9Hd to use the peerweb.site v. beta 0.7.134 directly from your ipfs client: `/ipfs/QmVRQEdiqNwVxsMJtrhX8EQRHF3NJj4Aui5jXGUtDhA9Hd
